...
pub fn parseMatch(allocator: std.mem.Allocator) !definitions.Match {
    ...
    // Compute file hash
    const body_pos = bufferReader.get_position();
    const file_bytes = bufferReader.buffer[body_pos..];
    ...
    const match_file_size = body_pos + 4 + file_bytes.len;
    ...
    return definitions.Match{
        ...
        .hash = null, // TODO: Convert hash from Sha1 state
